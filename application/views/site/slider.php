                ...
                <div class="panel panel-info">
                    <div class="panel-body" style="padding:0px">
                        ...
                        <?php foreach ($catalog as $value) {
                            ...
                            ?>
                            <div class="list-group" id = "mainmenu" style="position: relative;">
                                <a href="<?php echo base_url($name.'-c'.$value->id); ?>" class="list-group-item active">
                                <?php echo $value->name; ?>
                                </a>
                            </div>
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 clearpadding" id = "submenu" style="position: absolute;">
